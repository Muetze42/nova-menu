<template>
  <Icon
    v-if="icons && icons.heroicon"
    :name="icons.heroicon"
    :is="`heroicons-outline-${icons.heroicon}`"
    :height="icons.height"
    :width="icons.height"
